...
@section('content')
    ...
    <h1 id="datenschutzheader">Datenschutz</h1>

    <div id="datenschutz" class="col-md-12 col-sm-12">
        <p><strong><big>Datenschutzerklärung</big></strong></p>
        <p><strong>Allgemeiner Hinweis und Pflichtinformationen</strong></p>
        <p><strong>Benennung der verantwortlichen Stelle</strong></p>
        <p>Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</p>
        <p><span id="s3-t-firma">EasyPlan</span><br><span
                    id="s3-t-ansprechpartner">Sedrik Cirzel | Dominik Burkert</span><br><span id="s3-t-strasse">Rheingutstraße 36</span><br><span
                    id="s3-t-plz">78462</span> <span id="s3-t-ort">Konstanz</span></p>
        <p></p>
        ...
        <p>Mit einem modernen Webbrowser können Sie das Setzen von Cookies überwachen, einschränken oder unterbinden.
            ...
            gelöscht werden. Die Deaktivierung von Cookies
        ...
        <p>Das Setzen von Cookies, die zur Ausübung elektronischer Kommunikationsvorgänge oder der Bereitstellung
            ...
            6 Abs. 1 lit. f DSGVO. Als Betreiber dieser
        ...
        <p>Unsere Website vewendet Funktionen des Dienstes Twitter. Anbieter ist die Twitter Inc., 1355 Market Street,
            Suite 900, San Francisco, CA 94103, USA. </p>
        <p>Bei Nutzung von Twitter und der Funktion "Re-Tweet" werden von Ihnen besuchte Websites mit Ihrem
            ...
            Daten sowie die Nutzung dieser Daten durch Twitter haben wir keine Kenntnis. Einzelheiten finden Sie in der
            Datenschutzerklärung von Twitter: <a href="https://twitter.com/privacy">https://twitter.com/privacy</a>.</p>
        <p>Sie können Ihre Datenschutzeinstellungen bei Twitter ändern: <a href="https://twitter.com/account/settings">https://twitter.com/account/settings</a>
        </p>
        <p>
